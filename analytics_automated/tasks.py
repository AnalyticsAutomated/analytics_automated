...
def task_runner(self, uuid, step_id, task_name):
    """
    ...
    update_submission_state(s, True, step_id, self.request.id, 'Running step :' + step_id)
    ...
    update_submission_state(s, True, step_id, self.request.id, 'Completed step :' + step_id)


def update_submission_state(s, claim, step, id, message):
    """
