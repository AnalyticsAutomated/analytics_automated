...
class Backend(models.Model):
    #Handling choices http://www.b-list.org/weblog/2007/nov/02/handle-choices-right-way/
    LOCALHOST = 1
    GRIDENGINE = 2
    RSERVE = 3
    HADOOP = 4
    ...
    def __str__(self):
        return self.name
#TODO:Not clear if the path to the processed file root should be in the backend or
#in the task table. I guess it is more of a property of the backend though
#This will likely expand lots as we understand the complexity of the backend
#set ups. adding it to task allows tasks to write to different places, the backend would
#be the default location in that instance.
...
class Job(models.Model):
    ...
    def __str__(self):
        return self.name
#TODO: set runnable true if all it's tasks exists, set false if a task needed has been deleted
...
#TODO: deleting a task should delete all it's params and set any jobs to runnable false where it is missing
